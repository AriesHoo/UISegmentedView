package com.aries.ui.widget.segmented;
...
/**
 * Created: AriesHoo on 2017-01-20 13:52
 * Function:分段选择器
 * Desc:
 */
public class UISegmentedView extends RadioGroup {
    ...
    public UISegmentedView(Context context, AttributeSet attrs) throws Exception {
        ...
        try {
            ...
            textSize = attributes.getFloat(R.styleable.UISegmentedView_textSize, 12);
            stroke = attributes.getFloat(R.styleable.UISegmentedView_stroke, 1);
